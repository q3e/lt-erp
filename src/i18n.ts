...
const resources = {
  en: {
    translation: {
      ...
      "demo": "Book a Demo",
      "state_of_market_title": "Why Kenyan SMBs Are Struggling",
      ...
      "pillars_subtitle": "Built for Kenyan SMBs who need compliance and control, not more complexity.",
      ...
      "case_distributor_desc": "How a manufacturing SMB reduced stock-outs and manual accounting errors by 80%. One dashboard for inventory, orders, and purchases—no more \"we thought we had it\" or mismatched spreadsheets.",
      ...
      "mess_items": ["WhatsApp orders buried in threads", "Telegram group chat confusion", "Excel errors & broken formulas", "Manual paper invoices"],
      "veritas_items": ["Real-time Dashboards", "Automated Sales Commissions", "1-Click Digital Invoicing", "eTIMS & KRA Compliance"],
