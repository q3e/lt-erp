...
const resources = {
  en: {
    translation: {
      "hero": "Stop the WhatsApp Chaos. Start Scaling with Clarity.",
      "sub": "Bespoke ERPNext implementations for Kenyan distributors and manufacturers. Centralize your sales, warehouse, and accounting into one high-performance system.",
  ...
  fr: {
    translation: {
      ...
      "veritas_title": "La Méthode Kultech",
